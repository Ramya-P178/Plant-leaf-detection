...
file_id = "1TJTL1UEzitfkDSSf0eYIk6hkdhrvKeNl"
url = 'https://drive.google.com/file/d/1TJTL1UEzitfkDSSf0eYIk6hkdhrvKeNl/view?usp=drive_link'
model_path = "trained_plant_disease_model.keras"

if not os.path.exists(model_path):
    st.warning("Downloading model from Google Drive...")
    gdown.download(url, model_path, quiet=False)s